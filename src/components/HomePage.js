		...
		<header className="App-header">
			...
			<Header />
				<div className = "home"> 
						...
						<p>В пириложение реализована возможность создавать списки с заметками. <br /> <br />
						   Также вы можете редактировать имена списков и текст самих заметок. 
							 Для этого необходимо сделать двойное нажатие на тексте заметки или списка.<br />
							 Для приминения изменений нажните левой кнопкой мыши за приделами редактируемого объекта.<br /><br />
